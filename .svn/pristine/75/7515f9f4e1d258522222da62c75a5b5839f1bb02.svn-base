...
*/
 ...
 $ACCESS_PWD='whenyourealise'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
 ...
 'user'=>"root",#required
 'pwd'=>"root", #required
 'db'=>"scotchbox",  #optional, default DB
